    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('category/list')}}">Category Data</a></li>
      ...
      <div class="col-md-8 offset-2">
          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                ...
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('category/export/pdf')}}">
                    <i class="fas fa-file-pdf" data-toggle="tooltip" data-html="true"title="Pdf"></i>
                  </a>
                </li>
                <li class="page-item">
                  <a class="page-link  bg-primary" target="_blank" href="{{url('category/export/excel')}}">
        ...
        <div class="row">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('category/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
