                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Gallery Content</th>
                            <th class="text-center">Gallery Image</th>
                    ...
                    <tbody>
                        @if(count($dataRow))
                            @foreach($dataRow as $row)  
                                <tr>
                                    <td class="text-center">{{$row->id}}</td><td class="text-center">{{$row->category_name}}</td><td class="text-center">{{$row->gallery_content}}</td><td class="text-center">{{$row->gallery_image}}</td>
