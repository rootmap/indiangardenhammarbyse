            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Menu Item Data</li>
                </ol>
              </div>
            </div>
            <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="card-header">
                  <h3 class="card-title">Menu Item Data</h3>
                    ...
                    <div class="card-tools">
                      <ul class="pagination pagination-sm float-right">
                        ...
                        <li class="page-item">
                          <a class="page-link" target="_blank" href="{{url('menuitem/export/pdf')}}">
                            <i class="fas fa-file-pdf" data-toggle="tooltip" data-html="true"title="Pdf"></i>
                          </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" target="_blank" href="{{url('menuitem/export/excel')}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{url('menuitem/delete/'.$row->id)}}" type="button" class="btn btn-default">
                                                Delete 
