    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('subcategory/list')}}">Sub Category Data</a></li>
      ...
      <div class="col-md-8 offset-2">
          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                <li class="page-item"><a class="page-link bg-primary" href="{{url('subcategory/list')}}"> Data <i class="fas fa-table"></i></a></li>
                <li class="page-item">
        ...
        <div class="row">
            <div class="col-sm-12">
              <!-- radio -->
              <div class="form-group">
              <label>Choose Sub Category Status</label>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-danger" href="{{url('subcategory/create')}}"><i class="far fa-times-circle"></i> Reset</a>
            </div>
          </form>
        </div>
        <!-- /.card -->
